...
export const TileLight: Story<ArticleListItemProps> = Template.bind({});
TileLight.args = {
    article: article,
    view: "tile",
};

export const TileDark: Story<ArticleListItemProps> = Template.bind({});
TileDark.args = {
    article: article,
    view: "tile",
};
...
export const ListDark: Story<ArticleListItemProps> = Template.bind({});
ListDark.args = {
    article: article,
    view: "list",
};
