...
const article = {
    id: "1",
    title: "Javascript news sdfsdfsdfsdf",
    ...
    type: ["IT", "ECONOMICS", "SCIENCE", "ECONOMICS"],
    blocks: [
        {
            id: "1",
            type: "TEXT",
...
export const TileLight: Story<ArticleListProps> = Template.bind({});
TileLight.args = {
    articles: articles,
    view: "tile",
};

export const TileDark: Story<ArticleListProps> = Template.bind({});
TileDark.args = {
    articles: articles,
    view: "tile",
};
...
export const ListDark: Story<ArticleListProps> = Template.bind({});
ListDark.args = {
    articles: articles,
    view: "list",
};
...
export const IsLoadingTileDark: Story<ArticleListProps> = Template.bind({});
...
export const IsLoadingListDark: Story<ArticleListProps> = Template.bind({});
